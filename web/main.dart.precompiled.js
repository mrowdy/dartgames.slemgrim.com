...
["", "main.dart", , F, {
  ...
  initMenu: function() {
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new L.Parallax(headerEl, 0, 0, 2, true).get$_handleScroll()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    heroEl = document.querySelector(".hero");
    t1 = H.setRuntimeTypeInfo(new W._EventStream(window, t1, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new L.Parallax(heroEl, 0, 60, 2, false).get$_handleScroll()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  },
...
["", "../lib/parallax.dart", , L, {
  "": "",
  Parallax: {
    "": "Object;_container,_scroll,_parallax$_offset,multiplicator,fixed",
    _handleScroll$1: [function($event) {
      ...
      J.set$backgroundPosition$x(this._container.style, "50% -" + (t1 + this._parallax$_offset) + "px");
    }, "call$1", "get$_handleScroll", 2, 0, 18]
  }
}],
]);
...
function dart_precompiled($collectedClasses) {
  ...
  function Parallax(_container, _scroll, _parallax$_offset, multiplicator, fixed) {
