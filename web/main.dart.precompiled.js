...
initMenu: function() {
  var t1, t2, headerEl, title, t3, heroEl, $scroll;
  ...
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(F.toggleMenu$closure), t1._useCapture);
  ...
  t3 = new G.Parallax(headerEl, 0, 0, 2, true).get$_handleScroll();
  ...
  t3 = new W._EventStream(window, t1, false);
  H.setRuntimeTypeInfo(t3, [null]);
  t2 = new G.Parallax(heroEl, 0, 60, 2, false).get$_handleScroll();
  ...
  t2._tryResume$0();
  $scroll = new V.ScrollToggle(0, 200, false, P.StreamController_StreamController(null, null, null, null, false, J.JSBool));
  t1 = new W._EventStream(window, t1, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = $scroll.get$_scroll_toggle$_handleScroll();
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(t2), t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
  t2 = new P._ControllerStream($scroll._onToggle);
  H.setRuntimeTypeInfo(t2, [null]);
  t2.listen$1(new F.initMenu_closure(title));
},
...
initMenu_closure: {"": "Closure;title_0",
...
Parallax: {"": "Object;_container,_parallax$_scroll,_parallax$_offset,multiplicator,fixed",
  _handleScroll$1: function($event) {
    var t1, t2;
    t1 = C.Window_methods.get$scrollY(window);
    if (typeof t1 !== "number")
      throw t1.$tdiv();
    this._parallax$_scroll = C.JSInt_methods.$tdiv(t1, this.multiplicator);
    if (this.fixed) {
      t1 = this._parallax$_scroll;
      t2 = C.Window_methods.get$scrollY(window);
      if (typeof t2 !== "number")
        throw H.iae(t2);
      this._parallax$_scroll = t1 + t2;
    }
    J.set$backgroundPosition$x(this._container.style, "50% -" + H.S(this._parallax$_scroll + this._parallax$_offset) + "px");
  },
  get$_handleScroll: function() {
    return new H.BoundClosure$1(this, G.Parallax.prototype._handleScroll$1, null, "_handleScroll$1");
  }
}}],
["scroll_toggle", "../lib/scroll_toggle.dart", , V, {
ScrollToggle: {"": "Object;_scroll,_height,_isOverHeight,_onToggle",
  _scroll_toggle$_handleScroll$1: function($event) {
    var t1, t2;
    this._scroll = C.Window_methods.get$scrollY(window);
    t1 = this._scroll;
    t2 = this._height;
    if (typeof t1 !== "number")
      throw t1.$gt();
  ...
  get$_scroll_toggle$_handleScroll: function() {
    return new H.BoundClosure$1(this, V.ScrollToggle.prototype._scroll_toggle$_handleScroll$1, null, "_scroll_toggle$_handleScroll$1");
  }
}}],
]);
...
init.globalFunctions.toggleMenu$closure = F.toggleMenu$closure = new P.Closure$1(F.toggleMenu, "toggleMenu$closure");
...
function dart_precompiled($collectedClasses) {
  ...
  function initMenu_closure(title_0) {
