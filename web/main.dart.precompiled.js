...
["", "main.dart", , F, {
  ...
  initMenu: function() {
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(F.toggleMenu$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    headerEl = document.querySelector(".header");
    title = headerEl.querySelector(".title");
    t1 = C.EventStreamProvider_scroll._eventType;
    t2 = H.setRuntimeTypeInfo(new W._EventStream(window, t1, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new G.Parallax(headerEl, 0, 0, 2, true).get$_handleScroll()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    heroes = W._FrozenElementList$_wrap(document.querySelectorAll(".hero"), null);
    heroes.forEach$1(heroes, new F.initMenu_closure());
    t2 = P.StreamController_StreamController(null, null, null, null, false, J.JSBool);
  ...
  toggleMenu: [function(evt) {
    ...
    if (t1 == null)
      return;
    J.get$classes$x(t1).toggle$1("show");
  }, "call$1", "toggleMenu$closure", 2, 0, 8],
  initMenu_closure: {
    "": "Closure:18;",
    call$1: function(hero) {
      var t1 = H.setRuntimeTypeInfo(new W._EventStream(window, C.EventStreamProvider_scroll._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new G.Parallax(hero, 0, 60, 2, false).get$_handleScroll()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    }
  },
  initMenu_closure0: {
    "": "Closure:11;title_0",
...
1],
["parallax", "../lib/parallax.dart", , G, {
  "": "",
  Parallax: {
    "": "Object;_container,_parallax$_scroll,_parallax$_offset,multiplicator,fixed",
    _handleScroll$1: [function($event) {
      var t1, t2;
      t1 = C.Window_methods.get$scrollY(window);
      if (typeof t1 !== "number")
        return t1.$tdiv();
      t1 = C.JSInt_methods.$tdiv(t1, this.multiplicator);
      this._parallax$_scroll = t1;
      if (this.fixed) {
        t2 = C.Window_methods.get$scrollY(window);
        if (typeof t2 !== "number")
          return H.iae(t2);
        t2 = t1 + t2;
        this._parallax$_scroll = t2;
        t1 = t2;
      }
      J.set$backgroundPosition$x(J.get$style$x(this._container), "50% -" + (t1 + this._parallax$_offset) + "px");
    }, "call$1", "get$_handleScroll", 2, 0, 19]
  }
}],
["scroll_toggle", "../lib/scroll_toggle.dart", , V, {
  "": "",
  ScrollToggle: {
    "": "Object;_scroll,_height,_isOverHeight,_onToggle",
    _scroll_toggle$_handleScroll$1: [function($event) {
      var t1, t2;
      t1 = C.Window_methods.get$scrollY(window);
      this._scroll = t1;
      t2 = this._height;
      if (typeof t1 !== "number")
        return t1.$gt();
      if (t1 > t2 && !this._isOverHeight) {
        this._isOverHeight = true;
        t1 = this._onToggle;
        if (t1._state >= 4)
          H.throwExpression(t1._badEventState$0());
        t1._async$_add$1(true);
      } else if (t1 <= t2 && this._isOverHeight) {
        this._isOverHeight = false;
        t1 = this._onToggle;
        if (t1._state >= 4)
          H.throwExpression(t1._badEventState$0());
        t1._async$_add$1(false);
      }
    }, "call$1", "get$_scroll_toggle$_handleScroll", 2, 0, 19]
  }
}],
]);
